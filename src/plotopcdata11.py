...
#             tmp_fn = '/Users/mmyu/Tools/eclipse463/workspace/plot_data_in_excel/rawdata2/cfeis01nas83_analytics/cfeis01nas832017-11-09_21_07_07_UTC/nfs4.ops_op.txt'
#             if fn != tmp_fn:
#                 continue
...
#  
#     g_one_storage_data_dir_name = options.opcDataDir
#     g_one_storage_data_dir_name = '/Users/mmyu/Tools/eclipse463/workspace/plot_data_in_excel/rawdata2/cfeis01nas104_analytics'
#     g_excel_file_name = os.path.basename(
#         g_one_storage_data_dir_name).split('_')[0] + ".xlsx"
#     """ Create a Pandas Excel g_excel_writer using XlsxWriter as the engine """
#     g_excel_writer = pd.ExcelWriter(g_excel_file_name, engine='xlsxwriter')
