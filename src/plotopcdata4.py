...
# def analyze_iscsi_ops_breakdown_ops(start_str, end_str, columns_dict):
...
def plot_excel_charts():
    ...
    draw_nfs_combined_chart(df, 'NFSv3_IOPS_BREAKDOWN',
                            'NFS Operations During Peak NFSv3 Ops', 2.5, 4.0)

    df = analyze_nfsv4_breakdown_by_ops_name()
    draw_nfs_combined_chart(df, 'NFSv4_IOPS_BREAKDOWN',
    ...
    draw_generic_line_chart(df, 'iSCSI_OPS_BREAKDOWN', 'iSCSI IOPS')
